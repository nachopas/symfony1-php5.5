...
Swift_DependencyContainer::getInstance()
  ...
  -> withDependencies(['mime.headerset', 'mime.qpcontentencoder', 'cache', 'mime.grammar', 'properties.charset'])
  ...
  -> withDependencies(['mime.headerset', 'mime.base64contentencoder', 'cache', 'mime.grammar'])
  ...
  -> withDependencies(['mime.qpheaderencoder', 'mime.rfc2231encoder', 'mime.grammar', 'properties.charset'])
