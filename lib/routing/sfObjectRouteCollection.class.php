...
class sfObjectRouteCollection extends sfRouteCollection
{
  ...
  public function __construct(array $options)
  {
    ...
    $this->options = array_merge(['actions'              => false, 'module'               => $this->options['name'], 'prefix_path'          => '/'.$this->options['name'], 'column'               => isset($this->options['column']) ? $this->options['column'] : 'id', 'with_show'            => true, 'segment_names'        => ['edit' => 'edit', 'new' => 'new'], 'model_methods'        => [], 'requirements'         => [], 'with_wildcard_routes' => false, 'default_params'   => []], $this->options);
