...
class sfValidatorTime extends sfValidatorBase
{
  ...
  protected function doClean($value)
  {
    ...
    else if ($regex = $this->getOption('time_format'))
    {
      ...
      {
        throw new sfValidatorError($this, 'bad_format', ['value' => $value, 'time_format' => $this->getOption('time_format_error') ? $this->getOption('time_format_error') : $this->getOption('time_format')]);
      }
