...
abstract class BaseArticle extends BaseObject implements Persistent
{
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticlePeer::TITLE)) {
            $criteria->add(ArticlePeer::TITLE, $this->title);
        }
        if ($this->isColumnModified(ArticlePeer::BODY)) {
            $criteria->add(ArticlePeer::BODY, $this->body);
        }
        if ($this->isColumnModified(ArticlePeer::ONLINE)) {
            $criteria->add(ArticlePeer::ONLINE, $this->online);
        }
        if ($this->isColumnModified(ArticlePeer::EXCERPT)) {
            $criteria->add(ArticlePeer::EXCERPT, $this->excerpt);
        }
        if ($this->isColumnModified(ArticlePeer::CATEGORY_ID)) {
            $criteria->add(ArticlePeer::CATEGORY_ID, $this->category_id);
        }
        if ($this->isColumnModified(ArticlePeer::CREATED_AT)) {
            $criteria->add(ArticlePeer::CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ArticlePeer::END_DATE)) {
            $criteria->add(ArticlePeer::END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(ArticlePeer::BOOK_ID)) {
            $criteria->add(ArticlePeer::BOOK_ID, $this->book_id);
        }
