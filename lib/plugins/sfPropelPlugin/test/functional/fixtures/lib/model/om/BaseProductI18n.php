...
abstract class BaseProductI18n extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProductI18nPeer::NUM_COLUMNS - ProductI18nPeer::NUM_LAZY_LOAD_COLUMNS).
        } catch (Exception $e) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
    {
        ...
        $result = [$keys[0] => $this->getId(), $keys[1] => $this->getCulture(), $keys[2] => $this->getName()];
        return $result;
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductI18nPeer::CULTURE)) {
            $criteria->add(ProductI18nPeer::CULTURE, $this->culture);
        }
        if ($this->isColumnModified(ProductI18nPeer::NAME)) {
            $criteria->add(ProductI18nPeer::NAME, $this->name);
        }
