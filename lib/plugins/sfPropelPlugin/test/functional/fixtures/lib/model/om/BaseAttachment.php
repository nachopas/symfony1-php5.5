...
abstract class BaseAttachment extends BaseObject implements Persistent
{
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AttachmentPeer::ARTICLE_ID)) {
            $criteria->add(AttachmentPeer::ARTICLE_ID, $this->article_id);
        }
        if ($this->isColumnModified(AttachmentPeer::NAME)) {
            $criteria->add(AttachmentPeer::NAME, $this->name);
        }
        if ($this->isColumnModified(AttachmentPeer::FILE)) {
            $criteria->add(AttachmentPeer::FILE, $this->file);
        }
