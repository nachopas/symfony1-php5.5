...
abstract class BaseProduct extends BaseObject implements Persistent
{
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductPeer::PRICE)) {
            $criteria->add(ProductPeer::PRICE, $this->price);
        }
        if ($this->isColumnModified(ProductPeer::A_PRIMARY_STRING)) {
            $criteria->add(ProductPeer::A_PRIMARY_STRING, $this->a_primary_string);
        }
