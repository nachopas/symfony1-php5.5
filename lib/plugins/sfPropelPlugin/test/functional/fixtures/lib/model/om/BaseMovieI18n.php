...
abstract class BaseMovieI18n extends BaseObject implements Persistent
{
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
    {
        ...
        $result = [$keys[0] => $this->getId(), $keys[1] => $this->getCulture(), $keys[2] => $this->getTitle()];
        return $result;
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MovieI18nPeer::ID)) {
            $criteria->add(MovieI18nPeer::ID, $this->id);
        }
        if ($this->isColumnModified(MovieI18nPeer::CULTURE)) {
            $criteria->add(MovieI18nPeer::CULTURE, $this->culture);
        }
        if ($this->isColumnModified(MovieI18nPeer::TITLE)) {
            $criteria->add(MovieI18nPeer::TITLE, $this->title);
        }
