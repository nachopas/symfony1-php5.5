...
$form = new AuthorForm($table->create(['Articles' => [['title' => 'Article 1'], ['title' => 'Article 2'], ['title' => 'Article 3']]]));
...
$form = new AuthorForm($table->create(['Articles' => [['title' => 'Article 1'], ['title' => 'Article 2']]]));
...
$form = new ArticleForm(Doctrine_Core::getTable('Article')->create(['Author' => ['name' => 'John Doe']]));
