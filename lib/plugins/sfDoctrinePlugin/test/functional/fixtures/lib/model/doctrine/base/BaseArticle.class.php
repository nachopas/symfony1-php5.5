 ...
 * @method bool                getIsOnHomepage() Returns the current record's "is_on_homepage" value
 * @method string              getTitle()        Returns the current record's "title" value
 * @method string              getBody()         Returns the current record's "body" value
 * @method string              getTestColumn()   Returns the current record's "test_column" value
 * @method int                 getViews()        Returns the current record's "views" value
...
abstract class BaseArticle extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('is_on_homepage', 'boolean', null, [
            'type' => 'boolean',
        ]);
        ...
        $this->hasColumn('test_column', 'string', 255, [
            'type' => 'string',
            'length' => 255,
        ]);
        $this->hasColumn('views', 'integer', null, [
            'type' => 'integer',
        ]);
