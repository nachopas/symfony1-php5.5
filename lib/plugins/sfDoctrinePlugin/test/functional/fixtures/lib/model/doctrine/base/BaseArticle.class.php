...
abstract class BaseArticle extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('author_id', 'integer', null, ['type' => 'integer']);
        $this->hasColumn('is_on_homepage', 'boolean', null, ['type' => 'boolean']);
        $this->hasColumn('title', 'string', 255, ['type' => 'string', 'unique' => true, 'length' => 255]);
        $this->hasColumn('body', 'string', 255, ['type' => 'string', 'length' => 255]);
        $this->hasColumn('test_column', 'string', 255, ['type' => 'string', 'length' => 255]);
        $this->hasColumn('views', 'integer', null, ['type' => 'integer']);
        $this->hasColumn('type', 'string', 255, ['type' => 'string', 'length' => 255]);

        $this->setSubClasses(['BlogArticle' => 
        ['type' => 'BlogArticle']]);
    }
    ...
    public function setUp()
    {
        ...
        [0 => 'title', 1 => 'body', 2 => 'test_column']]);
        $sluggable1 = new Doctrine_Template_Sluggable(['fields' => 
        [0 => 'title'], 'uniqueBy' => 
        [0 => 'lang', 1 => 'title']]);
